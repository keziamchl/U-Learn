        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="~/Home/Index">
                    <i class="fas fa-graduation-cap"></i>U-Learn
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="~/Home/Cources">Courses</a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container pt-md-4">
                <div class="row footer-top-29">
                    <div class="col-lg-4 col-md-6 footer-list-29">
                        ...
                        <p class="mb-2">Phone Number : +(62) 851 xxx xxxx</a></p>
                        <p class="mb-2">Email : ULearn_info@example.com</a></p>
                    </div>
                    <div class="col-lg-2 col-md-3 col-6 footer-list-29 mt-md-0 mt-4">
                        <ul>
                            <h6 class="footer-title-29">Quick Links</h6>
                            <li><a href="~/Home/About">About Us</a></li>
                            <li><a href="~/Home/Cources">Courses</a></li>
                ...
                <p class="copy-footer-29 text-center pt-lg-2 mt-5 pb-2">
                    © 2022 U-Learn. All rights reserved. 
                </p>
                <!-- //copyright -->
            </div>
        </div>
