    ...
    <div class="container pb-md-5 pb-4">
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-lg-6 about-2-secs-left ps-lg-5">
                ...
                <p>
                    Consectetur adipiscing elit. Aliquam sit amet
                ...
                <div class="d-flex align-items-center mt-5">
                    ...
                    <a class="btn btn-style-primary ms-4" href="contact.html">
        ...
        <div class="d-lg-flex align-items-center justify-content-between">
            ...
            <div class="right-content-call mt-lg-0 mt-4">
                <ul class="buttons">
                    ...
                    <li>
                        <a href="contact.html" class="btn btn-style btn-style-2 mt-lg-0 mt-3">Join for free</a>
                    </li>
                </ul>
            </div>
        </div>
